...
function excelResponse(rows:BuildingRow[],baseName:string){
 ...
 const completedStyle={fill:{patternType:"solid",fgColor:{rgb:"C6EFCE"}},font:{color:{rgb:"17212B"}}},totalStyle={fill:{patternType:"solid",fgColor:{rgb:"D9EAF7"}},font:{bold:true,color:{rgb:"17212B"}}};rows.forEach((b,index)=>{if(b.completed)styleRow(sheet,index+1,completedStyle)});styleRow(sheet,rows.length+1,totalStyle);XLSX.utils.book_append_sheet(book,sheet,"GF Bina Listesi");
