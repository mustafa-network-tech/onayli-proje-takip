...
export const metadata={title:"HP Odaklı Projeler",description:"BF / GF proje ve imalat takip paneli"};
...
export default function Layout({children}:{children:React.ReactNode}){
 return <html lang="tr"><body><div className="shell"><aside className="side"><div className="brand">HP ODAKLI<br/>PROJELER</div><nav><Link href="/">Dashboard</Link><Link href="/projects/GF">GF Projeleri</Link><Link href="/projects/BF">BF Projeleri</Link><Link href="/search">Global Arama</Link><Link href="/import">Excel Yükle</Link><Link href="/imports">Yüklenen Excel Dosyaları</Link><Link href="/performance">EKİP PERFORMANSI</Link></nav><div aria-hidden="true" style={{marginTop:48,padding:"22px 0 38px",color:stroke,overflow:"hidden"}}><div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:7,whiteSpace:"nowrap",fontFamily:'"Segoe Script","Brush Script MT","Segoe Print","Bradley Hand",cursive',fontSize:17,fontWeight:500,fontStyle:"italic",lineHeight:1.15,letterSpacing:"-1px",transform:"rotate(-12deg)",transformOrigin:"center"}}><span>🌿</span><span>kendi halinde 1i</span><span>🕊️</span></div><div style={{marginTop:68,display:"flex",alignItems:"center",justifyContent:"center",gap:8,whiteSpace:"nowrap",fontFamily:'Impact,"Arial Narrow","Arial Black",sans-serif',fontSize:23,fontWeight:900,fontStyle:"italic",letterSpacing:".5px",lineHeight:1.05,transform:"rotate(-12deg)",transformOrigin:"center"}}><SickleHammerIcon/><span style={{color:"transparent",WebkitTextStroke:`1px ${stroke}`,textShadow:"none"}}>devrim şart</span><VictoryHandIcon/></div></div></aside><main className="main">{children}</main></div></body></html>
}
